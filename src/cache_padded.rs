...
/// Alias to [`CachePadded`](CachePadded)`<`[`AtomicU8`]`>`
pub type CachePaddedAtomicU8 = CachePadded<AtomicU8>;
#[allow(
    rustdoc::redundant_explicit_links,
    reason = "It is needed for right IDE doc formating"
)]
/// Alias to [`CachePadded`](CachePadded)`<`[`AtomicU16`]`>`
pub type CachePaddedAtomicU16 = CachePadded<AtomicU16>;
#[allow(
    rustdoc::redundant_explicit_links,
    reason = "It is needed for right IDE doc formating"
)]
/// Alias to [`CachePadded`](CachePadded)`<`[`AtomicU32`]`>`
pub type CachePaddedAtomicU32 = CachePadded<AtomicU32>;
#[allow(
    rustdoc::redundant_explicit_links,
    reason = "It is needed for right IDE doc formating"
)]
/// Alias to [`CachePadded`](CachePadded)`<`[`AtomicU64`]`>`
pub type CachePaddedAtomicU64 = CachePadded<AtomicU64>;
#[allow(
    rustdoc::redundant_explicit_links,
    reason = "It is needed for right IDE doc formating"
)]
/// Alias to [`CachePadded`](CachePadded)`<`[`AtomicUsize`]`>`
pub type CachePaddedAtomicUsize = CachePadded<AtomicUsize>;

#[allow(
    rustdoc::redundant_explicit_links,
    reason = "It is needed for right IDE doc formating"
)]
/// Alias to [`CachePadded`](CachePadded)`<`[`AtomicI8`]`>`
pub type CachePaddedAtomicI8 = CachePadded<AtomicI8>;
#[allow(
    rustdoc::redundant_explicit_links,
    reason = "It is needed for right IDE doc formating"
)]
/// Alias to [`CachePadded`](CachePadded)`<`[`AtomicI16`]`>`
pub type CachePaddedAtomicI16 = CachePadded<AtomicI16>;
#[allow(
    rustdoc::redundant_explicit_links,
    reason = "It is needed for right IDE doc formating"
)]
/// Alias to [`CachePadded`](CachePadded)`<`[`AtomicI32`]`>`
pub type CachePaddedAtomicI32 = CachePadded<AtomicI32>;
#[allow(
    rustdoc::redundant_explicit_links,
    reason = "It is needed for right IDE doc formating"
)]
/// Alias to [`CachePadded`](CachePadded)`<`[`AtomicI64`]`>`
pub type CachePaddedAtomicI64 = CachePadded<AtomicI64>;
#[allow(
    rustdoc::redundant_explicit_links,
    reason = "It is needed for right IDE doc formating"
)]
/// Alias to [`CachePadded`](CachePadded)`<`[`AtomicIsize`]`>`
pub type CachePaddedAtomicIsize = CachePadded<AtomicIsize>;

#[allow(
    rustdoc::redundant_explicit_links,
    reason = "It is needed for right IDE doc formating"
)]
/// Alias to [`CachePadded`](CachePadded)`<`[`AtomicPtr`]`<T>>`
pub type CachePaddedAtomicPtr<T> = CachePadded<AtomicPtr<T>>;
#[allow(
    rustdoc::redundant_explicit_links,
    reason = "It is needed for right IDE doc formating"
)]
/// Alias to [`CachePadded`](CachePadded)`<`[`AtomicBool`]`>`
pub type CachePaddedAtomicBool = CachePadded<AtomicBool>;
